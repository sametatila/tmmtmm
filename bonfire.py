...
#Normal variables
login_url = "https://www.bonfire.com/login/"
...
#Login Info
driver.find_element_by_xpath('//*[@id="fnc-login-email"]').send_keys(username1)
time.sleep(3)
driver.find_element_by_xpath('//*[@id="fnc-login-password"]').send_keys(password)
time.sleep(3)
...
#Login Button
driver.find_element_by_xpath('//*[@id="fnc-login-popup-form"]/div[4]/bf-animation-button/button').click()
time.sleep(5)
###End
