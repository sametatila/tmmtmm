...
#Login Info
driver.find_element_by_xpath('//*[@id="login-email"]').send_keys(username1)
time.sleep(3)
driver.find_element_by_xpath('//*[@id="login-password"]').send_keys(password)
time.sleep(3)

#Login Button
driver.find_element_by_xpath('//*[@id="content"]/div/div/div[1]/div[2]/div/div/div/div/div/div[1]/form/div[3]/input').click()
time.sleep(3)
